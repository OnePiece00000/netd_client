#ifndef AIDL_GENERATED_ANDROID_NET_BP_NETD_H_
#define AIDL_GENERATED_ANDROID_NET_BP_NETD_H_
...
public:
  ...
  ::android::binder::Status firewallReplaceUidChain(const ::std::string& chainName, bool isWhitelist, const ::std::vector<int32_t>& uids, bool* _aidl_return) override;
  ::android::binder::Status bandwidthEnableDataSaver(bool enable, bool* _aidl_return) override;
  ::android::binder::Status networkCreatePhysical(int32_t netId, int32_t permission) override;
  ::android::binder::Status networkCreateVpn(int32_t netId, bool secure) override;
...
#endif  // AIDL_GENERATED_ANDROID_NET_BP_NETD_H_
