#ifndef AIDL_GENERATED_ANDROID_NET_I_NETD_H_
#define AIDL_GENERATED_ANDROID_NET_I_NETD_H_
...
public:
  ...
  virtual ::android::binder::Status firewallReplaceUidChain(const ::std::string& chainName, bool isWhitelist, const ::std::vector<int32_t>& uids, bool* _aidl_return) = 0;
  virtual ::android::binder::Status bandwidthEnableDataSaver(bool enable, bool* _aidl_return) = 0;
  virtual ::android::binder::Status networkCreatePhysical(int32_t netId, int32_t permission) = 0;
  virtual ::android::binder::Status networkCreateVpn(int32_t netId, bool secure) = 0;
...
public:
  ...
  ::android::binder::Status networkCreatePhysical(int32_t, int32_t) override {
    return ::android::binder::Status::fromStatusT(::android::UNKNOWN_TRANSACTION);
  }
  ::android::binder::Status networkCreateVpn(int32_t, bool) override {
    return ::android::binder::Status::fromStatusT(::android::UNKNOWN_TRANSACTION);
  }
...
#endif  // AIDL_GENERATED_ANDROID_NET_I_NETD_H_
